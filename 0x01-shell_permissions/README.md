...
File 5-execute creates a script that adds execute permission to the owner of the file
...
File 12-directory_permissions creates a script that creates a directory called my_dir with permissions 751 in the working
